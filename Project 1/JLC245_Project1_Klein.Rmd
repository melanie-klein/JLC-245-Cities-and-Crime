...
# Finding 1
day of week, then by shift
saturday sunday more midnight shift. weekdays more day and evening shift
Visual 1
```{r echo=FALSE, message=FALSE, warning=FALSE}
ggplot(dc.data, aes(dow)) + geom_bar(stat = "count", aes(fill = SHIFT), position = position_stack(reverse = TRUE)) + theme_classic() +
  labs(
...
State a finding
This is the new thing that you’ve identified from the data
Provide your evidence
This is typically a statistical reference
Add the context 
This is the integration of the stat(s) and the finding
Compare your finding to the norm/average, or a similar measure in the data
...
roughly, approximately, more than, less than
